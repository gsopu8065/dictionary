                ...
                controller: ['$scope', '$element', '$timeout', function($scope, $element, $timeout) {
                    ...
                    var sortCards = function() {
                        ...
                        for(i = 0; i < existingCards.length; i++) {
                            ...
                            if(!card) continue;
                            if(i > 0) {
                                // card.style.transform = card.style.webkitTransform = 'translate3d(0, ' + 0 + 'px, 0) scale('+ 0 +')';
                                (function(j) {
                                    $timeout(function() {
                                        var top = (i * 25);
                                        ...
                                        var animation = collide.animation({
                                            ...
                                            .on('step', function(v) {
                                                existingCards[j].style.transform = card.style.webkitTransform = 'translate3d(0, ' + (j * 25)*v + 'px, 0) scale('+ scale*v +')';
                                            })
                                            .start();
                                    }, 100 * j);
                                })(i);
